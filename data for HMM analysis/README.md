...
This is the data used for the analysis of the paper 'A general hidden Markov model framework for capturing changes in species behaviour under disturbance in acoustic time series'.
...
3c_states: Daily state classifications (Normal, Warning, or Disturbed) interpreted based on the 3-state zero mean constrained model (3C)

3c_p_states: Daily state classifications (Normal, Warning, or Disturbed) interpreted based on the the 3-state zero mean constrained model with precipitation (3C_p)
